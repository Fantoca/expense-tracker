...
export default function Home() {
  const [items, setItems] = useState([
    // { name: "Coffe", price: 80.5 },
    // { name: "Movie", price: 45.5 },
    // { name: "Date", price: 5.5 },
  ]);
        ...
        <div className="bg-slate-800 p-4 rounded-lg">
          ...
          <ul>
            {items.map((item, id) => (
              <li
                key={id}
                className="my-4 w-full flex justify-between bg-slate-950 rounded-lg"
              >
                ...
                <button
                  ...
                  className="ml-8 p-4 border-l-2 border-slate-900 hover:bg-slate-950 w-16 "
                >
                  X
                </button>
              </li>
